        ...
        <el-col :span="22">
            <el-form :model="form" label-width="120px" :rules="formRules" ref="form" @submit.native.prevent>
                ...
                <el-form-item prop="pic_list" label="产品详情图">
                    <preview-img v-for="(url, index) in form.detail_imgs" :key="index" :url="url" alt="" width="200px"/>
                    <div>图片尺寸: 750 px * 750 px</div>
                </el-form-item>
                <el-form-item prop="pic_list" label="其他证书1">
                    <preview-img class="m-r-15 m-t-15" v-for="(url, index) in form.certificate1" :key="index" :url="url" alt="" width="200px"/>
                    <div></div>
                </el-form-item>
                <el-form-item prop="pic_list" label="其他证书2">
                    <preview-img class="m-r-15 m-t-15" v-for="(url, index) in form.certificate2" :key="index" :url="url" alt="" width="200px"/>
                    <div></div>
                </el-form-item>
                <el-form-item prop="pic_list" label="其他证书3">
                    <preview-img class="m-r-15 m-t-15" v-for="(url, index) in form.certificate3" :key="index" :url="url" alt="" width="200px"/>
                    <div></div>
                </el-form-item>
                <el-form-item>
