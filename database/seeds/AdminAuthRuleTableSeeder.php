...
class AdminAuthRuleTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('admin_auth_rules')->insert([
            ...
            ['id' => 6, 'name' => '商品管理', 'level' => 1, 'url' => '/admin/items', 'url_all' => '/admin/items,/api/admin/items,/api/admin/item/add,/api/admin/item/edit,/api/admin/item/del,/api/admin/item/changeStatus', 'sort' => 3, 'status' => 1, 'pid' => 0],
        ]);
    }
}