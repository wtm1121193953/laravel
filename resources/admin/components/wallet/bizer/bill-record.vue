<template>
    <page title="业务员账户交易记录" :breadcrumbs="{业务员账户管理: '/wallet/bizer'}">
        ...
        <el-table :data="list" v-loading="tableLoading" stripe>
            ...
            <el-table-column prop="type" label="交易类型">
                <template slot-scope="scope">
                    ...
                    <span v-else-if="scope.row.type == 9">被分享人消费奖励(业务员)</span>
                    <span v-else-if="scope.row.type == 10">被分享人消费奖励退款(业务员)</span>
