...
class AdminAuthRuleTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('admin_auth_rules')->insert([
            ...
            ['id' => 5, 'name' => '运营中心管理', 'level' => 1, 'url' => '/admin/opers', 'url_all' => '/admin/opers,/api/admin/opers,/api/admin/oper/add,/api/admin/oper/edit,/api/admin/oper/del,/api/admin/oper/changeStatus', 'sort' => 2, 'status' => 1, 'pid' => 0],
            ['id' => 6, 'name' => '商品管理', 'level' => 1, 'url' => '/admin/goods', 'url_all' => '/admin/goods,/api/admin/goods,/api/admin/goods/add,/api/admin/goods/edit,/api/admin/goods/del,/api/admin/goods/changeStatus,/api/admin/suppliers/all,/api/admin/categories/all,/api/admin/goods/changeStock', 'sort' => 3, 'status' => 1, 'pid' => 0],
