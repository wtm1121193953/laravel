    ...
    export default {
        ...
        methods: {
            ...
            download() {
                ...
                location.href = '/api/oper/wallet/consume/exportExcel?consumeQuotaNo=' + query.consumeQuotaNo + '&startDate=' + query.startDate + '&endDate=' + query.endDate +'&status=' + query.status;
            },
            detail(row) {
                router.push({
