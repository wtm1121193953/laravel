    ...
    <page title="超市订单管理">
        <el-tabs type="card" v-model="activeName" @tab-click="tabClick">
            ...
            <span slot="label">
                ...
                <cs-list :activeTab="activeName" status="8" @refresh="getUndeliveredNum"></cs-list>
            </el-tab-pane>
            <el-tab-pane name="notTakeBySelf">
            <span slot="label">
                待自提 <span style="color: red">{{notTakeBySelfNum}}</span>
            </span>
                <cs-list :activeTab="activeName" status="9" @refresh="getUndeliveredNum"></cs-list>
            </el-tab-pane>
            <el-tab-pane name="delivered" label="已发货">
                <cs-list :activeTab="activeName" status="10"></cs-list>
            </el-tab-pane>
            <el-tab-pane name="finished" label="已完成">
                <cs-list :activeTab="activeName" status="7"></cs-list>
            </el-tab-pane>
            <el-tab-pane name="refunded" label="已退款">
                <cs-list :activeTab="activeName" status="6"></cs-list>
            </el-tab-pane>
            <el-tab-pane name="all" label="全部">
                <cs-list :activeTab="activeName" status="" @refresh="getUndeliveredNum"></cs-list>
            </el-tab-pane>
        </el-tabs>
    </page>
</template>
