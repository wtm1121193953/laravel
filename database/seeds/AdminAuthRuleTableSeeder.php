...
class AdminAuthRuleTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('admin_auth_rules')->insert([
            ...
            ['id' => 5, 'name' => '运营中心管理', 'level' => 1, 'url' => '/admin/opers', 'url_all' => '/admin/opers,/api/admin/opers,/api/admin/oper/add,/api/admin/oper/edit,/api/admin/oper/changeStatus,/api/admin/oper_account/add,/api/admin/oper_account/edit', 'sort' => 2, 'status' => 1, 'pid' => 0],
        ]);
    }
}