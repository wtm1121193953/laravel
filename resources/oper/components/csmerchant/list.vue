    ...
    <page title="超市商户列表" v-loading="isLoading">
        <el-form class="fl" inline size="small">
            ...
            <el-form-item label="商户状态" prop="status">
                <el-select clearable clearable v-model="query.status" size="small" class="w-150">
            ...
            <el-form-item label="审核状态" prop="audit_status">
                <el-select clearable clearable v-model="query.audit_status" placeholder="请选择">
                    <el-option label="全部" value=""/>
            ...
            <el-button class="fr inline" size="small" type="success" @click="add">提交商户审核信息</el-button>
        </el-form>
