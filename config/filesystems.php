    ...
    */
    ...
    'disks' => [
        ...
        'cosv5' => [
            ...
            'timeout'         => config('cos.timeout', 60),
            'connect_timeout' => config('cos.connect_timeout', 60),
            'bucket'          => config('cos.bucket', 'daqian-public-1257640953'),
            'cdn'             => config('cos.cos_url'),
            'scheme'          => config('cos.scheme', 'https'),
        ],
