...
Route::prefix('user')
    ...
    ->middleware('user')->group(function (){
        ...
        Route::get('invite/qrcode', 'InviteChannel@getInviteQrcode')->middleware(UserLoginFilter::class);
        Route::get('invite/getInviterBySceneId', 'InviteChannel@getInviterInfo');
