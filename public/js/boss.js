...
throw new Error("Cannot find module \"../../assets/components/leftMenu.vue\"");
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_2_vuex__["c" /* mapState */])(['theme'])),
        ...
        relocation: function relocation() {
            ...
            if (this.$route.path == '/boss') {
                ...
                if (lastVisitedMenu) {
                    ...
                    this.$menu ? this.$menu.toFirstMenu() : setTimeout(function () {
                        _this.$menu.toFirstMenu();
                    }, 100);
                }
            }
        }
        ...
        if (this.$route.query && this.$route.query.sign) {
            __WEBPACK_IMPORTED_MODULE_0__assets_js_api__["a" /* default */].post('/boss/account/freeLogin', _self.$route.query).then(function (res) {
                __WEBPACK_IMPORTED_MODULE_0__assets_js_api__["a" /* default */].handlerRes(res).then(function (data) {
                    ...
                    bus.$on('globalLoading', function (loading) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    data: function data() {
        return {
            ...
            formRules: {
                ...
                verifyCode: [{ required: true, message: '请输入验证码', trigger: 'blur' }, { min: 4, max: 4, message: '请输入4位验证码', trigger: 'blur' }]
            },
            verifyUrl: '/boss/public/getVerify',
            verifyImg: '/boss/public/getVerify',
            loading: false,
    ...
    methods: {
        refreshVerify: function refreshVerify() {
            ...
            this.verifyUrl = '';
            setTimeout(function () {
                _this.verifyUrl = _this.verifyImg + '?v=' + moment().unix();
            }, 300);
        },
        relocation: function relocation() {
        ...
        doLogin: function doLogin() {
            var _self = this;
            _self.loading = true;
            __WEBPACK_IMPORTED_MODULE_0__assets_js_api__["a" /* default */].post('/boss/account/login', this.form).then(function (res) {
                __WEBPACK_IMPORTED_MODULE_0__assets_js_api__["a" /* default */].handlerRes(res).then(function (data) {
            ...
            [
              _vm.logo_type == "1"
                ? [
                    _c("img", {
                      staticClass: "logo",
                      attrs: { src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../assets/images/logo.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) }
                    })
                  ]
                : [
                ...
                _c(
                  ...
                  [
                    ...
                    _c("img", {
                      ...
                      attrs: { src: _vm.verifyUrl, width: "150" },
                      on: {
                        click: function($event) {
                          _vm.refreshVerify()
                        }
...
throw new Error("Cannot find module \"../assets/components/data-page/page.vue\"");
throw new Error("Cannot find module \"../assets/components/upload/single-image-upload\"");
...
__WEBPACK_IMPORTED_MODULE_2_vue___default.a.component('page', __WEBPACK_IMPORTED_MODULE_10__assets_components_data_page_page_vue___default.a);

__WEBPACK_IMPORTED_MODULE_2_vue___default.a.component(__WEBPACK_IMPORTED_MODULE_11__assets_components_upload_single_image_upload___default.a.name, __WEBPACK_IMPORTED_MODULE_11__assets_components_upload_single_image_upload___default.a);
...
__WEBPACK_IMPORTED_MODULE_2_vue___default.a.prototype.$api = __WEBPACK_IMPORTED_MODULE_12__assets_js_api__["a" /* default */];
...
// 设置Lockr前缀
__WEBPACK_IMPORTED_MODULE_5_lockr___default.a.prefix = 'boss_';
...
var routes = [{ path: '/login', component: __WEBPACK_IMPORTED_MODULE_0__components_login_vue___default.a, name: 'Login' }, {
    ...
    children: [{ path: '/refresh', component: __WEBPACK_IMPORTED_MODULE_1__components_refresh_vue___default.a, name: 'refresh' }]
},
