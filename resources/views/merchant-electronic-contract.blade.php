...
<div class="rules">
    ...
    <div class="content">
        ...
        <h3>甲方（盖章）：深圳大千生活科技有限公司</h3>
        <div style="height: 50px"></div>
        <h3>签约日期：{{$electronicContract['created_at']}}</h3>
        <div style="height: 100px;"></div>
        <h3>乙方（盖章）：【{{$merchantInfo['name']}}】</h3>
        <div style="height: 50px;"></div>
        <h3>联系人：{{$merchantInfo['contacter']}}</h3>
        <div style="height: 50px;"></div>
        <h3>联系人：{{$merchantInfo['contacter_phone']}}</h3>
        <div style="height: 50px;"></div>
        <h3>签约日期：{{$electronicContract['created_at']}}</h3>
    </div>
</div>
